...
class HistoryTest(ChromeDriverTestCase):
    ...
    def test_revision_button(self):
        ...
        self.assertTextIsPresent("Many Submitters")
        ...
        self.click_by_text("Go to the latest version")
        self.assertEqual(self.live_server_url + reverse("paper", args=[3]), self.browser.url)
