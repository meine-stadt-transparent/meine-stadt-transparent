...
DTSTART;TZID=Europe/Berlin:20170910T120000
DTEND;TZID=Europe/Berlin:20170910T180000
...
DTSTART;TZID=Europe/Berlin:20170901T120000
DTEND;TZID=Europe/Berlin:20170901T140000
...
DTSTART;TZID=Europe/Berlin:20170908T120000
DTEND;TZID=Europe/Berlin:20170908T140000
...
DTSTART;TZID=Europe/Berlin:20170915T120000
DTEND;TZID=Europe/Berlin:20170915T140000
...
DTSTART;TZID=Europe/Berlin:20170922T120000
DTEND;TZID=Europe/Berlin:20170922T140000
...
class TestICal(TestCase):
    ...
    def test_meeting(self):
        ...
        assert response == expected_meeting

        event = icalendar.cal.Component.from_ical(response).subcomponents[0]
        assert event.get("dtstart").dt.tzinfo.zone == settings.TIME_ZONE
        assert event.get("dtstart").dt.hour == 12
        assert event.get("dtend").dt.tzinfo.zone == settings.TIME_ZONE
        assert event.get("dtend").dt.hour == 18

    def test_meeting_series(self):
        response = self.client.get("/organization/2/ical/").content.decode().strip()
        assert response == expected_meeting_series
        assert len(icalendar.cal.Component.from_ical(response).subcomponents[0]) == 7
